...
//Входные данные: Функция сортировки принимает массив объектов,, созданных из класса "Card", который представлен ниже. С обязательно заданными параметрами свойств "from" и "to".

//Выходные данные: Массив отсортированных карт(объектов).
